...
## Project Structure
    ...
    ├── prd_reorg_demo_coe_38468  # Django project configurations
...
1. Clone this repo and `cd prd_reorg_demo_coe_38468`
...
2. Clone this repo and `cd prd_reorg_demo_coe_38468`
